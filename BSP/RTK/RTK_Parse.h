...
#define RMC_MAX_Len 100 // 定义RMC数据长度
#define GGA_MAX_Len 100 // 定义GGA数据长度
#define GSA_MAX_Len 100 // 定义GSA数据长度
#define GSV_MAX_Len 100 // 定义GSV数据长度
#define VTG_MAX_Len 100 // 定义VTG数据长度
#define GLL_MAX_Len 100 // 定义GLL数据长度
...
typedef struct
{
    ...
    char HDOP[5];          // HDOP
    char altitude[8];      // 海拔高度
    char geoidHeight[8];   // 大地水准面高度
